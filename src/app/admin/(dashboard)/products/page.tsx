...
import ProductToast from "@/components/admin/ProductToast";
          ...
          <tbody className="divide-y divide-lav-100">
            {items.map((p) => (
              <tr key={p.id} className="hover:bg-lav-50">
                <td className="p-3">
                  <div className="flex items-center gap-3">
                    <div className="relative h-11 w-11 shrink-0 overflow-hidden rounded-lg">
                      <ProductMedia
                        url={p.images[0]?.url ?? "placeholder:default"}
                        alt={p.name}
                        sizes="44px"
                      />
                    </div>
                ...
                <td className="hidden p-3 text-lav-700 sm:table-cell">
                ...
                <td className="p-3 text-right">
                  <Link
                    ...
                    className="inline-grid h-8 w-8 place-items-center rounded-full text-lav-600 hover:bg-lav-100"
                    aria-label="Edit"
                  >
